...
export class FinancialsDailySnapshot extends Entity {
  ...
  get protocolTreasuryUSD(): BigDecimal | null {
    let value = this.get("protocolTreasuryUSD");
  ...
  set protocolTreasuryUSD(value: BigDecimal | null) {
    if (!value) {
      this.unset("protocolTreasuryUSD");
    } else {
      this.set("protocolTreasuryUSD", Value.fromBigDecimal(<BigDecimal>value));
    }
  }
...
export class VaultDailySnapshot extends Entity {
  constructor(id: string) {
    ...
    this.set("totalValueLockedUSD", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("totalVolumeUSD", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("inputTokenBalances", Value.fromBigInt(BigInt.zero()));
    this.set("outputTokenSupply", Value.fromBigInt(BigInt.zero()));
    this.set("outputTokenPriceUSD", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("blockNumber", Value.fromBigInt(BigInt.zero()));
    this.set("timestamp", Value.fromBigInt(BigInt.zero()));
  ...
  get inputTokenBalances(): BigInt {
    let value = this.get("inputTokenBalances");
    return value!.toBigInt();
  }

  set inputTokenBalances(value: BigInt) {
    this.set("inputTokenBalances", Value.fromBigInt(value));
  }
