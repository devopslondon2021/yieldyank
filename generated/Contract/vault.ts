...
export class vault extends ethereum.SmartContract {
  ...
  getActualLeverage(): BigInt {
    let result = super.call(
      "getActualLeverage",
      "getActualLeverage():(uint256)",
      []
    );
  ...
  try_getActualLeverage(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getActualLeverage",
      "getActualLeverage():(uint256)",
      []
...
export class ConstructorCall__Inputs {
  ...
  get _rewardController(): Address {
    return this._call.inputValues[1].value.toAddress();
  }

  get _tokenDelegator(): Address {
    return this._call.inputValues[2].value.toAddress();
  }

  get _avToken(): Address {
    return this._call.inputValues[3].value.toAddress();
  }

  get _avDebtToken(): Address {
  ...
  get _leverageLevel(): BigInt {
    return this._call.inputValues[6].value.toBigInt();
  }

  get _safetyFactor(): BigInt {
    return this._call.inputValues[7].value.toBigInt();
  }

  get _leverageBips(): BigInt {
    return this._call.inputValues[8].value.toBigInt();
  }

  get _minMinting(): BigInt {
...
export class DepositFor1Call extends ethereum.Call {
  get inputs(): DepositFor1Call__Inputs {
    return new DepositFor1Call__Inputs(this);
  }

  get outputs(): DepositFor1Call__Outputs {
    return new DepositFor1Call__Outputs(this);
  }
}

export class DepositFor1Call__Inputs {
  _call: DepositFor1Call;

  constructor(call: DepositFor1Call) {
    this._call = call;
  }
...
export class DepositFor1Call__Outputs {
  _call: DepositFor1Call;
...
export class UpdateLeverageCall extends ethereum.Call {
  get inputs(): UpdateLeverageCall__Inputs {
    return new UpdateLeverageCall__Inputs(this);
  }

  get outputs(): UpdateLeverageCall__Outputs {
    return new UpdateLeverageCall__Outputs(this);
  }
}

export class UpdateLeverageCall__Inputs {
  _call: UpdateLeverageCall;

  constructor(call: UpdateLeverageCall) {
    this._call = call;
  }
...
export class UpdateLeverageCall__Outputs {
  _call: UpdateLeverageCall;
